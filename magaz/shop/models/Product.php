...
public static function updateAboutRu($s)
    {       $db = Db::getConnection();
/*$s = htmlentities($s, ENT_NOQUOTES, 'UTF-8');
$q = $db->prepare("UPDATE about SET 'about_ru' = :a");
$q->execute(array('a' => htmlspecialchars($s)));*/

$query = "UPDATE about SET about_ru = ' ".$s."'";
//print($query);
$db->query($query);
    }
public static function updateAboutEn($s)
    {       $db = Db::getConnection();
/*$s = htmlentities($s, ENT_NOQUOTES, 'UTF-8');
$q = $db->prepare("UPDATE about SET 'about_ru' = :a");
$q->execute(array('a' => htmlspecialchars($s)));*/

$query = "UPDATE about SET about_en = ' ".$s."'";
//print($query);
$db->query($query);
    }
    /**
